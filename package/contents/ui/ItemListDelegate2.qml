...
Item {
    ...
    height: iconSize + PlasmaCore.Units.smallSpacing*2
    ...
    PlasmaCore.IconItem {
        ...
        animated: false
        usesPlasmaTheme: item.ListView.view.usesPlasmaTheme
    ...
    PlasmaCore.ToolTipArea {
        ...
        onContainsMouseChanged: item.ListView.view.itemContainsMouseChanged(containsMouse)
    }
